...
class JsEditor extends Component {
  ...
  _updateJs() {
    let codeHackStyle = document.getElementById('ibc__script');
  ...
  handleClick() {
    ...
    let scriptContainer = document.getElementById('ibc__scriptContainer');
  ...
  render() {
    return (
      <div className="ibc-editor__detail__container is-js">
        <h2 className="ibc-editor__head">{this.props.name}</h2>
